...
Class Site_controller extends MY_Controller {
    ...
    function __construct() {
        ...
        foreach ($settings as $setting) {
            $this->config->item[$setting['fieldoption']] = $setting['value'];
        }
    }
    ...
    protected function title($title) {
        $this->data['title'] = $this->config->item['title'].' :: ' . trim($title);
    }
...
//                return mail($to, $subject, $message, $headers);
    ...
    function save_user_activity($data) {
        return $this->m_common->insert_row('user_activity', $data);
    }
