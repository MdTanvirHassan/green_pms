                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <ul class="nav nav-tabs md-tabs " role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#task7" role="tab"><i class="fa fa-cog "></i><br>Tasks</a>
                                                <div class="slide"></div>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#department7" role="tab"><i class="fa fa-check-square"></i><br>Departments</a>
                                                <div class="slide"></div>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#dept_task7" role="tab"><i class="fa fa-bell"></i><br>Dept. Task</a>
                                                <div class="slide"></div>
                                            </li>
                                            <li class="nav-item">
                                                      ...
                                                      <div class="col-md-4" style="padding-right: 0px;">
                                                            <div class="media align-items-stretch" style="margin-bottom: 5px;">
                                                                        ...
                                                                        <div class="p-2 media-body" style="background: #f2f3f8;">
                                                                            <h6 style="margin-top:15px;">Department &nbsp;&nbsp;&nbsp;<i class="fa fa-exclamation-triangle" style="color:red;"></i> <span id="dept_val"><?php if($dept_ramain_value>0) echo $dept_ramain_value; ?></span></h6>
                                                             ...
                                                             <div class="media align-items-stretch" style="margin-bottom: 5px;">
                                                                        ...
                                                                        <div class="p-2 media-body" style="background: #f2f3f8;">
                                                                            <h6 style="margin-top:15px;">Tasks</h6>
                                                         ...
                                                         <ul class="list-group">
                                                             <li class="list-group-item">
                                                                 <span class="badge  badge-pill float-right" style="background:#A7ABF2;color:#ffffff;"><?php if(!empty($project_info[0]['contract_date'])) echo date('d/m/Y',strtotime($project_info[0]['contract_date'])); ?></span>
                                                                 Contract Date
                                                             </li>
                                                              <li class="list-group-item">
                                                                 <span class="badge badge-info badge-pill float-right"><?php if(!empty($project_info[0]['contract_period'])) echo $project_info[0]['contract_period']; ?></span>
                                                                 Contract Period
                                                             </li>
                                                              <li class="list-group-item">
                                                                 <span class="badge badge-info badge-pill float-right"><?php if(!empty($project_info[0]['execution_period'])) echo $project_info[0]['execution_period']; ?></span>
                                                                 Execution Period
                                                             </li>
                                                              <li class="list-group-item">
                                                                 <span class="badge badge-warning badge-pill float-right" style="background:#FF8D43;color:#ffffff;"><?php if(!empty($project_info[0]['execution_start_date'])) echo date('d/m/Y',strtotime($project_info[0]['execution_start_date'])); ?></span>
                                                                 Execution Start Date
                                                             </li>
                                                              <li class="list-group-item">
                                                                 <span class="badge badge-warning badge-pill float-right" style="background:#FF8D43;color:#ffffff;"><?php if(!empty($project_info[0]['scheduled_completion_date'])) echo date('d/m/Y',strtotime($project_info[0]['scheduled_completion_date'])); ?></span>
                                                                 Completion Date
                                                             </li>
                                                              <li class="list-group-item">
                                                                 <span class="badge badge-warning badge-pill float-right" style="background:#FF8D43;color:#ffffff;"><?php if(!empty($project_info[0]['actual_completion_date'])) echo date('d/m/Y',strtotime($project_info[0]['actual_completion_date'])); ?></span>
                                                                   ...
                                                                   <?php if(!empty($tasks)){ ?>
                                                                        ...
                                                                        foreach($tasks as $key=>$task){ 
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <?php if(!empty($tasks[$key]['sub_tasks'])){ 
                                                                                      $j=0;
                                                                                ...
                                                                                <?php  foreach($tasks[$key]['sub_tasks'] as $key1=>$subtask){
                                                                                            $j++; ?>
                                                                                                   <?php if(!empty($subtask['sub_sub_tasks'])){ 
                                                                                                       ...
                                                                                                       <tr class="subtask<?php echo $i; ?>  border-bottom-primary" style="display:none;">
                                                                                                          <!--  
                                                                                                     ...
                                                                                                     <?php  
                                                                                                            foreach($subtask['sub_sub_tasks'] as $key2=>$sub_sub_task){
                                                                                                                      $k++; 
                                                                                                                      ?>
                                                                                                        <tr class="roottask<?php echo $i; ?> border-bottom-primary" style="display:none;">
                                                                                                   ...
                                                                                                   <?php } ?>  
                                                                                     <?php } }else{ ?>
                                                                                     <tr class="subtask<?php echo $i; ?> border-bottom-primary" >
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            foreach($project_users as $usr){
                                                                                ...
                                                                                switch($usr['user_type']){
                                                                                    ...
                                                                                    case 2 : $type='Project Manager';break;
                                                                                    case 3 : $type='Monitor';break;
                                                                                    case 4 : $type='Moderator';break;
                                                                                    default : $type='Moderator';break;
                                                                            }
                                                                                ?>
                                                                            <tr class="border-bottom-primary">
                                                                                ...
                                                                                <?php if(!empty($tasks[$key]['sub_tasks'])){ 
                                                                                    ...
                                                                                    <tr class="border-bottom-primary">
                                                                                           ...
                                                                                           <!-- <td><input type="checkbox" name="dept_check[]" id="dept_check_<?php echo $task['task_id'] ?>"> <?php echo $i; ?></td>-->
                                                                                            ...
                                                                                            <td><?php echo $task['task_name'];  ?></td>
                                                                                            <td id="startdate_<?php echo $task['task_id'] ?>"></td>
                                                                                             <td id="enddate_<?php echo $task['task_id'] ?>"></td>
                                                                                ...
                                                                                <?php  foreach($tasks[$key]['sub_tasks'] as $key1=>$subtask){
                                                                                                   ...
                                                                                                   <?php if(!empty($subtask['sub_sub_tasks'])){ 
                                                                                                       ...
                                                                                                       <tr class="dept_subtask<?php echo $i; ?> border-bottom-primary" style="display:none;">
                                                                                                           ...
                                                                                                           <!-- <td><input type="checkbox" name="dept_check[]" id="dept_check_<?php echo $subtask['task_id'] ?>"> <?php echo $i.'.'.$j; ?></td>-->
                                                                                                            ...
                                                                                                            <td style="padding-left:1.2rem !important;"><?php echo $subtask['task_name'];  ?></td>
                                                                                                        <td id="startdate_<?php echo $subtask['task_id'] ?>"></td>
                                                                                             <td id="enddate_<?php echo $subtask['task_id'] ?>"></td>
                                                                                                     ...
                                                                                                     <?php  
                                                                                                        ...
                                                                                                        <tr class="dept_roottask<?php echo $i; ?> border-bottom-primary" style="display:none;">
                                                                                                         ...
                                                                                                         <!--   <td><input type="checkbox" name="dept_check[]" id="dept_check_<?php echo $sub_sub_task['task_id'] ?>" class="rootitem"> <?php echo $i.'.'.$j.'.'.$k; ?></td>-->
                                                                                                            ...
                                                                                                            <td style="padding-left:2.3rem !important;"><?php echo $sub_sub_task['task_name'];  ?></td>
                                                                                            <td id="startdate_<?php echo $sub_sub_task['task_id'] ?>"></td>
                                                                                             <td id="enddate_<?php echo $sub_sub_task['task_id'] ?>"></td>
                                                                                             <td id="moderator_<?php echo $sub_sub_task['task_id'] ?>"><a href="javascript:">Set Moderator</a></td>
                                                                                            
                                                                                                            <td> 
                                                                                                                    <a href="javascript:" onclick="get_dept_task_status(<?php echo $sub_sub_task['task_id'] ?>)"> <i class="  fa fa-cogs"></i></a>
                                                                                           ...
                                                                                           <td id="startdate_<?php echo $subtask['task_id'] ?>"></td>
                                                                                             ...
                                                                                             <td id="moderator_<?php echo $subtask['task_id'] ?>">Moderator</td>
                                                                                                            ...
                                                                                                            <td> 
                                                                                                                    <a href="javascript:" onclick="get_dept_task_status(<?php echo $subtask['task_id'] ?>)"> <i class="  fa fa-cogs"></i></a>
                                            ...
                                            <div class="modal-body">
                                             <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                            <div class="form-group">
                                                               <label style="margin-bottom: 0px;">Percentage</label>
                                                              <input  id="multiple_enrolled_percentage" type="text" class="form-control form-txt-primary">
...
//         $('#task_currency').html(str);
     ...
     function task_currency_amount_calculation(id=''){
            ...
            var eq_val_percent=Number($('#task_currency_value_'+id).val());
          ...
          //  var exchange_amount=amount/exchange_rate;
            ...
            if(amount!=0){
                $('#task_currency_amount_'+id).val(amount);
            }else{
                $('#task_currency_amount_'+id).val('');
            }    
     ...
     function task_currency_value_calculation(id=''){
       ...
       if(currency_value!='' || currency_value!=0){
           if(currency_value<=remaining_task_value){
                $('#task_currency_value_'+id).val(currency_value);
                $('#task_currency_value_'+id).css('border','1px solid #ccc');
                $('#task_currency_value_error_'+id).html('');
           }else{
                $('#task_currency_value_'+id).val('');
...
//            total_currency_amount=Number(total_currency_amount)+Number(currency_amount);
     ...
     function edit_task_currency_amount_calculation(id=''){
          //alert(id);
            ...
            var eq_val_percent=Number($('#edit_task_currency_value_'+id).val());
            var amount=(total_eq_val*eq_val_percent)/100;
            $('#edit_task_currency_amount_'+id).val(amount);
     ...
     function edit_task_currency_value_calculation(id=''){
       ...
       var currency_value=(eq_val_amount*100)/total_eq_val;
        $('#edit_task_currency_value_'+id).val(currency_value);
...
<script type="text/javascript">
      ...
      function sub_task_currency_amount_calculation(id=''){
            ...
            var eq_val_percent=Number($('#sub_task_currency_value_'+id).val());
            var amount=(total_eq_val*eq_val_percent)/100;
          //  var exchange_amount=amount/exchange_rate;
...
//            total_currency_amount=Number(total_currency_amount)+Number(currency_amount);
      ...
      function edit_sub_task_currency_amount_calculation(id=''){
          //alert(id);
            ...
            var eq_val_percent=Number($('#edit_sub_task_currency_value_'+id).val());
            var amount=(total_eq_val*eq_val_percent)/100;
            $('#edit_sub_task_currency_amount_'+id).val(amount);
      ...
      function edit_sub_task_currency_value_calculation(id=''){
       ...
       var currency_value=(eq_val_amount*100)/total_eq_val;
        $('#edit_sub_task_currency_value_'+id).val(currency_value);
        ...
        $.ajax({
             ...
             success: function (data) {
               ...
               var equivalent_currency_value=data.task_info[0]['task_equivalent_currency'];
                ...
                $('#edit_sub_task_name').val(task_name);
...
<script type="text/javascript">
    ...
    function root_task_currency_amount_calculation(id=''){
          ...
          //alert(id);
            ...
            var eq_val_percent=Number($('#root_task_currency_value_'+id).val());
            var amount=(total_eq_val*eq_val_percent)/100;
          //  var exchange_amount=amount/exchange_rate;
...
//            total_currency_amount=Number(total_currency_amount)+Number(currency_amount);
    ...
    function edit_root_task_currency_amount_calculation(id=''){
          //alert(id);
            ...
            var eq_val_percent=Number($('#edit_root_task_currency_value_'+id).val());
            var amount=(total_eq_val*eq_val_percent)/100;
            $('#edit_root_task_currency_amount_'+id).val(amount);
    ...
    function edit_root_task_currency_value_calculation(id=''){
       ...
       var currency_value=(eq_val_amount*100)/total_eq_val;
        $('#edit_root_task_currency_value_'+id).val(currency_value);
...
<script type="text/javascript">
    ...
    $('#dept_discard').click(function(){
     ...
     $('#department_save').click(function(){
        ...
        $.ajax({
             ...
             data:{project_id:project_id,dept_name:dept_name,dept_value:dept_value},
             dataType: "json",
             success: function (data) {
    ...
    $('#department_update').click(function(){
        ...
        $.ajax({
             ...
             data:{project_id:project_id,dept_id:dept_id,dept_name:dept_name,dept_value:dept_value},
             dataType: "json",
             success: function (data) {
                   if(data.status=="success"){
                        var dept_value=100-(data.dept_info[0]['toal_dept_value']);
            ...
            return false;
             ...
             success: function (data) {
                 if(data.status=='success'){
                     ...
                     $('#dept_task_start_date').val(data.task.start_date);
                     $('#dept_task_end_date').val(data.task.end_date);
...
$('#set_end_date').datepicker('setStartDate', dateToDMY(today));
   ...
   $(function () {
        ...
        var today = new Date(arrayDate[3], arrayDate[2]-1,arrayDate[1]);
        var date2 = '<?php echo date('d/m/Y', strtotime($project_info[0]['scheduled_completion_date'])); ?>';
