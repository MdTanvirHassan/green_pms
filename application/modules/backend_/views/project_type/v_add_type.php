...
<div class="card">
        ...
        <div class="card-block">
                                <form id="main" method="post" aenctype="multipart/form-data" action="<?php echo site_url('project_type/addEditproject_type'); ?>" >
                                  <div class="form-group row">
                                      <label class="col-sm-2 col-form-label">Project Type<sup style="color:red;">*</sup></label>
                                    <div class="col-sm-10">
                                      <input  type="text" required class="form-control" name="type" id="type" placeholder="Project Type">
