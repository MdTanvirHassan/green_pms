                                                        ...
                                                        foreach ($projects as $project) {
                                                            ...
                                                            <tr class="border-bottom-primary" onclick="get_project_dept_info(<?php echo $project['project_id'].','.$this->user_id; ?>)">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="progress">
                                                                        <div class="progress-bar" role="progressbar" style="width: <?php echo round($project['progress']); ?>%; <?php if(round($project['progress']) > 10){ echo 'color:#fff !important';}else{ echo 'color:#000 !important'; }?>" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><?php echo round($project['progress']); ?>%</div>
                                                                    </div>
                                                                    </a>    
                                                                </td>
                                                                <td>
                               ...
                               // $('#user_role').val(user_role);
                                ...
                                $(data.project_info).each(function (i, v) {
                                    var description = v.project_name.substring(0, 50);
                                     ...
                                     str+='<td><div class="progress"><div class="progress-bar" role="progressbar" style="width: '+v.progress+'%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">'+v.progress+'%</div></div></td>';
                                     str+='</tr>';
                                  });
                                 ...
                                 $(data.project_departments).each(function (j, w) {
                                     ...
                                     str1+='<div class="col-md-3 dept-box" style="margin-top:-30px;"><a href="javascript:" onclick="get_dept_task_info('+w.dept_id+','+w.project_id+')"><div class="card-block"><div class="shadow table-responsive" style="border:1px solid #BFBFBF;padding:10px;">';
                                 }else{
                                    str1+='<div class="col-md-3 dept-box" style="margin-top:-30px;"><div class="card-block"><div class="shadow table-responsive" style="border:1px solid #BFBFBF;padding:10px;">'; 
                                 }
                                     str1+='<h3 style="text-align: center;">'+w.dept_name+'</h3>';
                                     str1+='<div class="progress"><div class="progress-bar" role="progressbar" style="width: '+w.progress+'%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">'+w.progress+'%</div>';
                                     if(user_id == w.user_id){
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(data.status=='success'){
                                ...
                                $('#dept_progress_bar').html('<div class="progress-bar" role="progressbar" style="width: '+progress+'%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">'+progress+'%</div>');
                                var str='';
                                var j=0;
                                $(data.tasks).each(function (i, v) {
                                    ...
                                    if(v.sub_tasks!=''){
                                        ...
                                        str+='<div class="progress-bar" role="progressbar" style="width: '+v.percentage+'%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">'+v.percentage+'%</div>';
                                        str+='</div>';
                                        str+='</td>';
                                        str+='<td>';
                                        str+=' <div class="dropdown"> <i class="  fa fa-cogs" data-toggle="dropdown"></i>';
                                        ...
                                        $(v.sub_tasks).each(function (m, n) {
                                            ...
                                            if(n.sub_sub_tasks!=''){
                                                ...
                                                str+='<td>';
                                                str+='<div class="progress">';
                                                str+='<div class="progress-bar" role="progressbar" style="width: '+n.percentage+'%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">'+n.percentage+'%</div>';
                                                str+='</div>';
                                                str+='</td>';
                                                str+='<td>';
                                                str+=' <div class="dropdown"> <i class="  fa fa-cogs" data-toggle="dropdown"></i>';
                                                ...
                                                $(n.sub_sub_tasks).each(function (o, p) {
                                                    ...
                                                    str+='<td>';
                                                    str+='<div class="progress">';
                                                    str+='<div class="progress-bar" role="progressbar" style="width: '+p.percentage+'%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">'+p.percentage+'%</div>';
                                                    str+='</div>';
                                                    str+='</td>';
                                                    str+='<td>';
                                                    str+=' <div class="dropdown"> <i class="  fa fa-cogs" data-toggle="dropdown"></i>';
                                ...
                                $(data.task_files).each(function (i, v) {
                                  ...
                                  $(data.task_status).each(function (j, w) {
                                     ...
                                     if(w.status=="incomplete"){
                                        ...
                                        //str1+='<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">';
                                        if($.inArray('4', user_role_array)>-1){
                                            str1+='<div class="anil_nepal"><label class="switch switch-left-right" onclick="completeStatus('+w.task_id+','+w.dept_task_status_id+');"><input class="switch-input" type="checkbox">';
                                        ...
                                        //str1+='<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">';
                                        if($.inArray('4', user_role_array)>-1){
                                             str1+='<div class="anil_nepal"><label class="switch switch-left-right" onclick="resetStatus('+w.task_id+','+w.dept_task_status_id+');"><input class="switch-input" checked type="checkbox">';
