                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block tab-icon">
                            ...
                            <form action="<?php echo site_url('pms_report/remainingCostReport')?>" method="post">
                             <div class="row"> 
                                   ...
                                   <ul class="nav nav-tabs">
                                    ...
                                    <div class="tab-content" style="padding:20px">
                                        ...
                                        <div id="details" class="tab-pane fade">
                                            <h3 style="text-align: center;">Remaining Cost</h3>
                                            ...
                                            <table class="table">
                                                ...
                                                foreach ($departments as $d => $dept) { ?>
                                                    <tr>
                                                        <td style="text-align: center;background:lightblue;font-weight: bold" colspan="10"><?php echo $dept['dept_name']; ?></td>
                                                    </tr>
...
<!--                                                        <td><?php echo $row['task']['start_date']; ?></td>
                                                        ...
                                                        <td style="text-align:right"><?php echo number_format($row['remaining_amount'],2); ?></td>
