                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block tab-icon">
                            ...
                            <form action="<?php echo site_url('pms_report/monthlyCostReport')?>" method="post">
                             <div class="row">                              
                                   ...
                                   <ul class="nav nav-tabs">
                                    ...
                                    <div class="tab-content" style="padding:20px">
                                        ...
                                        <div id="details" class="tab-pane fade in active show">
                                            <h3 style="text-align: center;">Monthly Cost</h3>
                                            ...
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <th style="text-align:right">Consumption Amount</th>
                                                ...
                                                foreach ($departments as $d => $dept) { ?>
                                                    <tr>
                                                        <td style="text-align: center;background:lightblue;font-weight: bold" colspan="9"><?php echo $dept['dept_name']; ?></td>
                                                    </tr>
...
//                                                        exit;
                                                        ...
                                                        <?php if (!empty($row['sub_tasks'])) { 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-weight: bold;background:grey; text-align:right"><?php echo $row['total_cons']; ?></td>
                                                            ...
                                                            <?php foreach ($row['sub_tasks'] as $sl1 => $subtask) { ?>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        ?></td>
                                                                        <td style="text-align:right"><?php echo number_format($subtask['consumption_amount'],2); ?></td>
<!--                                                                        <td><?php echo $subtask['total']-$subtask['consumption_amount']; ?></td>-->
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            ?></td>
                                                                            <td style="text-align:right"><?php echo number_format($roottask['consumption_amount'],2); ?></td>
                                               ...
                                               <tr>
                                                   ...
                                                   <td style="text-align:right"><b><?php echo number_format($net_total_cons); ?></b></td>
