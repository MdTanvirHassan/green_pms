...
<div class="right_col" style="padding-bottom:20px;">
    ...
    <div class="card">
                ...
                <div class="row" style="">
                    ...
                    <div style="text-align: center" class="col-md-3">
                         <select class="custom-select" id="order_by" name="equivalent_currency">
                            ...
                            <option <?php if($order_by=='total') echo 'selected'; ?> value="total">Total Budgeting Value</option>
                        </select>                
                    ...
                    <thead>
                        <tr>
                           <!-- <th style="width:1%;">SL</th>-->
                            ...
                            <th style="width:10%;">Total Budgeting Value</th>
        ...
        <?php if (!empty($project['actual_completion_date'])) echo date('d-m-Y', strtotime($project['actual_completion_date'])); ?>
                                    ...
                                    <td>
        <?php echo round($project['total'],2); ?>
                                    </td>
                                    <td>
                                        <div class="progress">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                              ...
                                              <!-- <li role="presentation"><a  role="menuitem" tabindex="-1" href="javascript:delete_row('<?php echo site_url('project/deleteProject/' . $project['project_id']); ?>')" ><i class="fa fa-trash"></i>Delete</a></li>-->
                                                ...
                                                <li role="presentation"><a  role="menuitem" tabindex="-1" href="javascript:updateProjectProgress('<?php echo $project['project_id']; ?>')" ><i class="fa fa-check"></i>Check Progress</a></li>
                                                <li role="presentation"><a  role="menuitem" tabindex="-1" href="<?php echo site_url('project/sync_with_supply_chain/' . $project['project_id']); ?>" ><i class="fa fa-tree"></i>Sync with Supply Chain</a></li>
...
async function deleteProject(project_id = ''){
   ...
   async function cloneProject(project_id = ''){
        var r = confirm("Are you sure?");
        if (r == true){
            var r_status=await validate_password_b();
            if (r_status==true){
   ...
   async function updateProjectProgress(project_id = ''){
        var r = confirm("Are you sure?");
        if (r == true){
            var r_status=await validate_password_b();
            if (r_status==true){
            location.href='<?php echo site_url('backend/moderator/updateProgress/'); ?>/'+project_id;
            }
        }
