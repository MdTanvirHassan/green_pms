    ...
    $('#add_task').click(function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                unit: unit,
                quantity: quantity,
                task_equivalent_currency: task_equivalent_currency,
    ...
    $('#assign_user_save').click(function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                'project_id': <?php echo $project_info[0]['project_id']; ?>
            },
            dataType: "json",
            success: function(data) {
                if (data.status = "success") {
    ...
    $("#enrolled_save").click(function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                'dept_task_status_id': $('#dept_task_status_id').val()
            },
            dataType: "json",
            success: function(data) {
