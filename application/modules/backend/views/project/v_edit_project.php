...
<div class="card">
    ...
    <div class="card-block">
        <form id="main"  method="post" enctype="multipart/form-data" action="<?php echo site_url('project/addEditProject/' . $project_info[0]['project_id']); ?>" >
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn btn-primary m-b-0" onclick="javascript: confirmUpdate();">Submit</button>
                </div>
   ...
   async function confirmUpdate(){
      // alert('test');
        ...
        if (r == true){
            ...
            if(r_status==true){
                //window.location.replace('<?php //echo site_url("project"); ?>);
                $('#main').submit();
                //return true;
            }
        }
