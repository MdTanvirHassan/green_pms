                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block tab-icon">
                            ...
                            <form action="<?php echo site_url('pms_report/workScheduleReport')?>" method="post">
                             <div class="row">              
                                   ...
                                   <ul class="nav nav-tabs">
                                    ...
                                    <div class="tab-content" style="padding:20px">
                                        ...
                                        <div id="details" class="tab-pane fade in active show">
                                            <h3 style="text-align: center;">Work Schedule</h3>
...
<!--                                                    <th>Specification</th>
                                                ...
                                                foreach ($departments as $d => $dept) { ?>
                                                    <tr>
                                                        <td style="text-align: center;background:lightblue;font-weight: bold" colspan="3"><?php echo $dept['dept_name']; ?></td>
                                                    </tr>
