<style type="text/css">
    ...
    .well{
        ...
        margin-top: 135px;
        background-color: #77340A !important;
        padding: 8px;
        opacity: 0.9;
    }
    .login-bg{
    ...
    fieldset h3{ text-align: center; color:#fff;font-weight: bold; padding-bottom: 28px;border-bottom: 1px solid #D9D9D9}
            ...
            <form class="form-horizontal" accept-charset="UTF-8" role="form" method="post" action="backend/login/loginAction">
                <fieldset>
                    <div class='col-md-12 col-sm-12 col-xs-12'>
                        ...
                        <h2 style='color: #43C3BA;font-weight: bold'><img src='<?php echo site_url('images/'.$this->config->item['logo']); ?>' style='margin-right: 20px;width:250px;height:100px;'/><?php //echo $this->config->item['title']; ?></h2>
                    </div>
                    <h3>Login Panel</h3>
<!--                    <h4>CREDENTIALS</h4>-->
                    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <!--                        <label for="remember" class="remember"><input name="remember" type="checkbox" value="RememberMe"> Remember Me</label>-->
                            ...
                            <p class="center col-md-12 col-sm-12">
                                <input style='background: #43C3BA;margin-top: 0px' class="btn btn-primary" type="submit" value="SIGN IN">
                            </p>
                            <div style='width: 100%' class="input-prepend">
                                <a  href="<?php echo site_url('login/forgotPassword')?>"><span style="cursor:pointer;color:#fff;" for="remember" class="remember">Forgot Password ? </span></a>
                            </div>
                        </div>
                    </div>
                </fieldset>
