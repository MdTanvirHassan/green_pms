    ...
    type:"POST",
            ...
            if (data.status == "success"){
              ...
              //  alert($('.progress_task_'+dept_task.task_id).attr('style'))
                $('.progress_project_'+dept_task.project_id).attr('style',parseFloat(data.p_progress).toFixed(2)+'%');
                $('.progress_project_'+dept_task.project_id).html(parseFloat(data.p_progress).toFixed(2)+'%');
                $('.progress_dept_'+dept_task.dept_id).attr('style',parseFloat(data.d_progress).toFixed(2)+'%');
                $('.progress_dept_'+dept_task.dept_id).html(parseFloat(data.d_progress).toFixed(2)+'%');
                $('.progress_task_'+dept_task.task_id).attr('style',parseFloat(data.t_progress).toFixed(2)+'%');
