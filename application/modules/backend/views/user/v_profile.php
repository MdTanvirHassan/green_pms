...
<div class="card">
    ...
    <div class="card-block">
        <form id="main" method="post" enctype="multipart/form-data" action="<?php echo site_url('login/profile'); ?>/<?php echo !empty($user_info[0]['user_id']) ? $user_info[0]['user_id'] :''; ?>" onsubmit="javascript: return validate_user()">
            <div class="col-md-12">
                ...
                <div class="col-md-6 pull-right" style="float: right;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select disabled required name="usertype" id="usertype" class="form-control">
