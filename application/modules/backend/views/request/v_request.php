                                            ...
                                            <table class="table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr class="border-bottom-primary">
                                                        ...
                                                        <th style="width:25%;">Req. Details</th>
...
<script type="text/javascript">
    async function approveDeleteFile(r_id,project_id,dept_id,file_id){
    ...
    async function rejectDeleteFile(r_id,project_id,dept_id,file_id){
     ...
     async function approveResetStatus(r_id,project_id,dept_id,status_id){
    ...
    async function rejectResetStatus(r_id,project_id,dept_id,status_id){
