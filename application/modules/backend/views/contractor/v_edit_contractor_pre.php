 <div class="right_col" style="background-color: #f1f1f1;padding-bottom:20px;">
            ...
            <form enctype="multipart/form-data" action="<?php echo site_url('contractor/addEditContractor/'.$contractor_info[0]['contractor_id']); ?>" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input required class="form-control" id="fullname" name="fullname" type="text" value="<?php if(!empty($contractor_info[0]['fullname'])) echo $contractor_info[0]['fullname'];  ?>"></div>
                        </div>
                    </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-3 labeltext" style="text-align: right;"><label for="inputdefault">Address <sup>*</sup>:</label></div>
                            <div class="col-sm-8 col-md-5 "><input required class="form-control" id="address" name="address" type="text" value="<?php if(!empty($contractor_info[0]['address'])) echo $contractor_info[0]['address'];  ?>"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-5 "><input required class="form-control" id="phone" name="phone" type="text" value="<?php if(!empty($contractor_info[0]['phone'])) echo $contractor_info[0]['phone'];  ?>"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-sm-4 col-md-3 labeltext" style="text-align: right;"><label for="inputdefault">Email:</label></div>
                             <div class="col-sm-8 col-md-5 "><input class="form-control" id="email" name="email" type="text" value="<?php if(!empty($contractor_info[0]['email'])) echo $contractor_info[0]['email'];  ?>"></div>
                        </div>
                    </div>
                </div>
