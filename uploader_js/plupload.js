...
(function() {
	...
	var g = {
		...
		formatSize : function(n) {
			...
			if(n >= 1024){ //greater than or equals to 1 MB
				n = (n/1024).toFixed(0);
				unit = "MB";
			}

			if(n >= 1024){ //greater than or equals to 1 GB
				n = (n/1024).toFixed(precision);
				unit = "GB";
			}
			return n+" "+unit;
		},
		...
		formatTime : function(t){
			...
			if (t > 86400) {
				ret += (t / 86400).toFixed(0) + " Days";
				t = t % 86400;
			}
			else if (t > 3600) {
				ret += " "+(t / 3600).toFixed(0) + " Hours Remaining";
				t = t % 3600;
			}
			else if (t > 120) {
				ret += " "+(t / 60).toFixed(0) + " Minutes Remaining";
				t = t % 120;
			}
			else if (t > 60) {
				ret += " " + " Less than 2 minutes remaining";
				t = t % 60;
			}
			else if (t > 2) {
				ret += " " + " Less than 1 minute remaining";
				t = t % 2;
			}
			else {
				ret += " " + " Processing upload...";
			}
